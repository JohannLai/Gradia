...
enum ExerciseGuideCatalog {
    ...
    static let all: [ExerciseGuide] = [
        ...
        guide("C-04", "0400", "dumbbell seated one leg calf raise", "小腿", "0400-Ia7tumC", [
            "坐在训练凳上，膝盖约90°；将工作侧前脚掌放在杠铃片或踏板边缘。",
            "把哑铃稳定放在同侧大腿靠近膝盖的位置，另一只手扶稳哑铃。",
            "缓慢下放脚跟并在底部停1–2秒，感受小腿拉伸。",
            "用前脚掌发力抬高脚跟，顶部主动收缩1秒，再受控下降；完成后换侧。"
        ]),
